...
class NumeroTelefonoTest {
    ...
    void crearNumero_prefijoNulo_lanzaExcepcion() {
        ...
        assertEquals(NumeroTelefono.ERROR_CODIGO_INVALIDO, ex.getMessage(), "Debe lanzar excepción por prefijo nulo");
    }
    ...
    void crearNumero_numeroNulo_lanzaExcepcion() {
        ...
        assertEquals(NumeroTelefono.ERROR_NUMERO_INVALIDO, ex.getMessage(), "Debe lanzar excepción por número nulo");
    }
